  ...
  const option: EChartsOption = {
    ...
    tooltip: {
      ...
      formatter: (params: any) => {
        ...
        let result = "";
        if (alignMode === "absolute") {
          result = `<div style="font-weight: 600; margin-bottom: 8px;">${new Date(params[0].value[0]).toLocaleString("zh-CN")}</div>`;
        } else {
    ...
    <div className="w-full h-full flex flex-col gap-4">
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
          ...
          <div className="flex items-center gap-3">
            <Select.Root
              value={alignMode}
              onValueChange={(v) => setAlignMode(v as any)}
            >
              <Select.Trigger className="inline-flex items-center justify-between gap-2 px-3 py-1.5 bg-gray-900 border border-gray-600 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all min-w-[120px] text-xs text-gray-200">
                <Select.Value>
                  {alignMode === "absolute" ? "绝对时间" : "相对时间"}
                </Select.Value>
                <Select.Icon>
              ...
              <Select.Portal>
                ...
                >
                  <Select.Viewport className="p-1">
                    <Select.Item
                      value="absolute"
                      className="px-3 py-2 text-xs text-gray-200 hover:bg-gray-700 rounded cursor-pointer"
                    >
          ...
          {periods.length === 0 ? (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <p className="text-gray-400 mb-4">暂无对比数据</p>
                <button
                  onClick={() => setShowAddPeriod(true)}
      ...
      {periods.length > 0 && (
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-4">
          <h3 className="text-sm font-medium text-gray-200 mb-3">对比时间段</h3>
      ...
      {showAddPeriod && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-lg border border-gray-700 shadow-2xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-600 rounded-lg text-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
